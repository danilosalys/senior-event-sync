...
function createConnectionPool() {
  ...
  const sqlConfig = {
    server: config.seniorDatabase.server,
    user: config.seniorDatabase.user,
    password: config.seniorDatabase.password,
    database: config.seniorDatabase.database,
    port: config.seniorDatabase.port,
    options: {
      trustServerCertificate: config.seniorDatabase.trustServerCertificate,
